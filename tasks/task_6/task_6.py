...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        chroma_creator = ChromaCollectionCreator(d, embed_client)
        ####### YOUR CODE HERE #######
        with st.form("Load Data to Chroma"):
            ...
            if submitted:
                ...
                # create_chroma_collection() method: to create a Chroma collection from the processed documents. It takes the processed documents as input and constructs a collection that can be used for semantic search and information retrieval."""
                # ####### YOUR CODE HERE #######
                # query_chroma_collection(): utilizes the generated Chroma collection to extract relevant information corresponding to the query, aiding in quiz question generation. It allows you to search the Chroma collection for documents or information that match the query."""
                document = chroma_creator.query_chroma_collection(topic_input) # generates questions based on the created chroma
    if document:
