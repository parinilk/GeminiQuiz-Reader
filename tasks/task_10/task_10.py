...
if __name__ == "__main__":
    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                if submitted:
                    ...
                    # Steps 3-6: Initialize QuizGenerator, generate quiz, and set session state
        ...
        with st.container():
            ...
            with st.form("MCQ"):
                # Step 7: Set index_question using the Quiz Manager method
                ...
                # Step 8: Navigate to next and previous questions
